...
const char ssid[] = "TeoDan2.4"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "teofis2.4"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "54.205.75.72"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
...
const char MQTT_TOPIC_PUB[] = "alemania/stuttgart/stuttgart/" USER "/out"; //TODO Reemplace el valor por el tópico de publicación que le corresponde.
// El tópico de suscripción debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/in
const char MQTT_TOPIC_SUB[] = "alemania/stuttgart/stuttgart/" USER "/in"; //TODO Reemplace el valor por el tópico de suscripción que le corresponde.
...
void loop() {
  ...
  if(message.indexOf("HUMIDITY") > 0 && variableLed==0){
     digitalWrite(LED, HIGH);
     Serial.println("inicia");
          variableLed=1;
  }else{
     if(message.indexOf("HUMIDITY") < 0 && variableLed==1){
